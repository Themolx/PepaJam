...
var encounter_text = "Kebab."

var encounter_choices = [
	{
		"text": "Dát cígo.",
		"next_scene": "res://encounters/Reuseable/homeless_encounter_01_kebab.tscn",
		"effects": {
...
func _on_video_stream_player_finished() -> void:
		var story_manager = get_node("/root/Main/StoryManager")
		if story_manager:
			story_manager.load_encounter("res://encounters/Reuseable/homeless_encounter_01_kebab.tscn")
