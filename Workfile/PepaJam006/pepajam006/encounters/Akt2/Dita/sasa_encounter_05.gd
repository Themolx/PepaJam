...
var encounter_title = "Sasa05"
var dialogue = [
		"Kamo mam dost, jdem spat."
	]

var encounter_choices = [
	{
		"text": "Rum",
		"next_scene": "res://encounters/Finnish/sasa_ending.tscn",
		"effects": {
...
func on_encounter_start():
	...
	fade_out_and_load_scene("res://encounters/Finnish/sasa_ending.tscn")
