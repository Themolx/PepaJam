...
var encounter_text = "Fuha florenc, tak kam?"

var encounter_choices = [
	{
		"text": "se vyhcat",
		"next_scene": "res://encounters/Action/piss_encounter.tscn",
		"effects": {
	...
	{
		"text": "Na Karlín!",
		"next_scene": "res://encounters/Akt2/Karlin/karlin_encounter.tscn"
	}
] 
