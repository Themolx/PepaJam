...
var encounter_text = "The hedgehog leads you to a hidden garden behind the park. There's a small gathering of people having a midnight poetry reading. The hedgehog sits in the front row like a regular attendee."

var encounter_choices = [
	{
		"text": "Join the poetry reading",
	...
	{
		"text": "Quietly leave with the hedgehog",
		"next_scene": "res://encounters/HomeArrivalEncounter.tscn"
	}
]

func _ready():
	encounter_id = "hedgehog_adventure"
